...
#define ERR_NOTREGISTERED(host, target) (":" + host + " 451 " + host + " :" + target + " have not registered \r\n")
...
#define RPL_YOUREOPER(target) (": 381 " + target + " now an IRC operator\r\n")
#define ERR_NOPRIVILEGES(channel) ("481 " + channel + " :Permission Denied- You are not an IRC operator \r\n")
#define ERR_CHANOPRIVSNEEDED(channel, host) (":" + host + " 482 " + channel + " : not operator \r\n")
